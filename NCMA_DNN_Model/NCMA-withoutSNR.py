...
# 准备数据阶段
file = 'D:\\DataSet\degree-A-B-XOR.mat'  # matlib文件位置
...
# 训练
history_1 = model_1.fit(x_train, y_train, epochs=400, batch_size=1000, validation_data=(x_validate, y_validate))
...
ax3 = plt.subplot(2, 1, 1)  # 第二行
ax4 = plt.subplot(2, 1, 2)  # 第三行
