...
# 准备数据阶段
file = 'D:\\DataSet\degree-SNR=8-A-B-C.mat'  # matlib文件位置
...
model_1.add(layers.Dense(50, activation='relu', input_shape=(2,)))
model_1.add(layers.Dense(50, activation='relu'))
model_1.add(layers.Dense(50, activation='relu'))
model_1.add(layers.Dense(50, activation='relu'))
model_1.add(layers.Dense(7, activation="sigmoid"))
